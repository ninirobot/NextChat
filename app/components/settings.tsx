...
const TABS_CONFIG = [
  { key: SettingsTab.General, icon: "🛠️" },
  { key: SettingsTab.Sync, icon: "🔄" },
  { key: SettingsTab.Mask, icon: "🤹" },
  { key: SettingsTab.ModelService, icon: "🌐" },
  { key: SettingsTab.Model, icon: "🤖" },
  { key: SettingsTab.TTS, icon: "🎙️" },
] as const;

const TAB_LABELS: Record<SettingsTab, () => string> = {
  [SettingsTab.General]: () => Locale.Settings.Tab.General,
  [SettingsTab.Sync]: () => Locale.Settings.Tab.Sync,
  [SettingsTab.Mask]: () => Locale.Settings.Tab.Mask,
  [SettingsTab.ModelService]: () => Locale.Settings.Tab.ModelService,
  [SettingsTab.Model]: () => Locale.Settings.Tab.Model,
  [SettingsTab.TTS]: () => Locale.Settings.Tab.TTS,
};
      ...
      <div className={styles["settings"]}>
        ...
        <div className={styles["settings-tabs"]}>
          {TABS_CONFIG.filter((tab) => {
            if (
              tab.key === SettingsTab.ModelService &&
        ...
        <div className={styles["settings-content"]}>
          ...
          {/* ===== 模型服务 ===== */}
          {currentTab === SettingsTab.ModelService && (
            <>
              ...
              <List>
                ...
                <ListItem title="语音人物">
                  <Select
                    ...
                    onChange={(e) => {
                      config.update((c) => {
                        c.geminiLiveConfig.voice = e.target.value;
                      });
                    }}
                  >
                    {VOICES.map((v) => (
                  ...
                  >
                    <InputRange
                      ...
                      onChange={(e) => {
                        ...
                        config.update((c) => {
                          c.geminiLiveConfig.thinkingBudget = value;
                        });
                      }}
                    />
                  </ListItem>
                ...
                >
                  <InputRange
                    ...
                    onChange={(e) => {
                      ...
                      config.update((c) => {
                        c.geminiLiveConfig.speed = value;
                      });
                    }}
                  />
                </ListItem>
